...
| `/축구공` | 축구공 소환/소환위치/해제 | `minigame.admin` |
...
- **충돌 감지**: 벽과의 충돌 시 반사
- **마찰 효과**: 자연스러운 감속
- **자동 골 처리**: 첫 소환 후 골대에 들어간 축구공 자동 제거 및 재소환
- **설정 기반 소환**: config.yml에서 소환 위치 및 골대 좌표 설정
- **정확한 골대 영역**: 두 지점으로 정의된 직사각형 골대 영역

#### 축구공 명령어 상세
- `/축구공 소환`: 플레이어 앞에 축구공 소환 (자동 재소환 활성화)
- `/축구공 소환위치`: config.yml에 설정된 위치에 축구공 소환 (자동 재소환 활성화)
- `/축구공 해제`: 모든 축구공 제거 (자동 재소환 비활성화)
- `/축구공 골대표시`: 골대 영역을 블록으로 시각화 (빨간/파란 양털)
- `/축구공 골대제거`: 골대 표시 블록 제거
- `/축구공 상태`: 현재 축구공 개수 및 자동 재소환 상태 확인
